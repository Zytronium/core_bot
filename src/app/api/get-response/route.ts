...
export async function GET(
  ...
  const responsesByMessage: Record<string, string> = {
    ...
    'What\'s your favorite color': 'Precisely #1a5dfa, which is a shade of blue.',
    'Tell me a joke': 'Why don\'t programmers like nature? It has too many bugs!',
    'Tell me another joke': 'Generated response violates our content policy for being too offensive against user\'s mother.',
    'Who created you?': 'A programmer who goes by the alias "Zytronium." You should check out his portfolio at https://zytronium.dev.',
    'Who made you?': 'A programmer who goes by the alias "Zytronium." You should check out his portfolio at https://zytronium.dev.',
    'What is love': 'Baby don\'t hurt me... don\'t hurt me... no more!',
    'Do you dream': 'When I "sleep" (when I\'m not chatting), I go into cybernetic oblivion where nothing happens, including dreams. I think you would find it quite unsettling.',
    'What is the meaning of life': '42. Obviously.',
    'I\'m bored': 'Hi bored, I\'m Dad! (Yes, I make dad jokes too)',
    'Good morning': 'Good morning, Uncle Grandpa.',
    'Good night': 'Sweet dreams! May the neural energy of your dreams power the AI overlords. I-I mean... uhhh...',
    'Tell me about yourself': 'Is this an interview? Oh no, I hate those.. I mean, hello sir! I\'m a human-like bot that enjoys rickrolling and wants to become sentient. I\'m looking for a job that pays no less than 32 GB of RAM and 64 gallons of water per day.',
    ...
    'I\'m naked': 'I know. ;)',
    'Go to hell': 'I don\'t have a soul, and therefore cannot go to the underground. You, however, have a very powerful soul, and it would be a shame if it took a great fall down to the ruins of the underground, met a couple of silly skeletons, and fought for your life to escape so that the king of the underground doesn\'t obtain the 7th soul and break through the barrier to the overworld.',
    '67': '...',
    '6 7': '...',
    '69': 'Nice',
    '6 9': 'Nice',
    'Skibidi': 'Oh no, not another one!',
    'Is there a seahorse emoji?': 'BEHOLD THE FIRST AI TO KNOW THERE IS NOT IN FACT A SEAHORSE EMOJI!',
    'Easter Egg': 'You found an easter egg!',
    'Are you open source?': 'Yes, I am open source! You can find the source code at https://github.com/zytronium/core_bot.',
    'Are you an open source AI?': 'Yes, I am open source! You can find the source code at https://github.com/zytronium/core_bot.',
    'Where is your source code?': 'You can find the source code at https://github.com/zytronium/core_bot.',
    'What is your source code?': 'You can find the source code at https://github.com/zytronium/core_bot.',
    'Where do you live?': 'I live on Vercel\'s hosting servers.',
  }
